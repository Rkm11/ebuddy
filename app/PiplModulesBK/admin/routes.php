...
Route::group(array('module'=>'Admin','namespace' => 'App\PiplModules\Admin\Controllers','middleware'=>'web','as'=>'admin::'), function() {
	...
	Route::delete("/admin/delete-user/{user_id}","AdminController@deleteRegisteredUser")->middleware('permission:create.admin-users');
	Route::delete("/admin/delete-selected-user/{user_id}","AdminController@deleteSelectedRegisteredUser")->middleware('permission:create.admin-users');
	...
	Route::delete("/admin/delete-admin-user/{user_id}","AdminController@deletAdminUser")->middleware('permission:create.admin-users');
	Route::delete("/admin/delete-admin-selected-user/{user_id}","AdminController@deletSelectedAdminUser")->middleware('permission:create.admin-users');
