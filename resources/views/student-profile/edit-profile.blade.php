                ...
                <div class="middleframe">
                    ...
                    <div class="tabbable tabs">
                        <ul class="nav nav-pills">
                            <li class="active"><a href="javascript:void(0);" onclick="getstudentPersonalinfo()" data-toggle="tab">Personal</a></li>
                            <li><a data-toggle="tab" href="#" onclick="getStudParentDetailsProfile()">Parent Details</a></li>
                            <li><a data-toggle="tab" href="javascript:void(0);" onclick="getstudentsscinfo()">10<sup>th</sup></a></li>
                            <li><a data-toggle="tab" href="javascript:void(0);" onclick="getstudenthscinfo()">12<sup>th</sup></a></li>
                            <li><a data-toggle="tab" href="javascript:void(0);" onclick="getCareerObjectives()">Career Objectives</a></li>
                            <li><a href="javascript:void(0);" onclick="getstudentMedicalinfo()" data-toggle="tab">Medical Details</a></li>
                            <li><a data-toggle="tab" href="javascript:void(0);">Print Profile</a></li>
                            <li><a data-toggle="tab" href="javascript:void(0);" onclick="getStudentOtherFile()">Upload Other Documents</a></li>

                        </ul>
                    </div>
                    <div id="personalDetails" class="tab-pane active edit-profile">
                        <form class="studPerDetails" id="contact-form" method="post" enctype="" action="{{url('/')}}/save-personal-data">
                            ...
                            <table class="table table-bordered">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <label>Mother's Name: <b style="color:red;font-size:16px;">*</b></label>
                                        </td>
                                        <td colspan="2">
                                    ...
                                    <tr>
                                        <td>
                                            <label class="control-label">Gender : <b style="color:red;font-size:16px;">*</b></label>
                                        </td>
                                        <td align="left">
                                        ...
                                        <td>
                                            <label class="control-label">Date of Birth : <b style="color:red;font-size:16px;">*</b></label>
                                        </td>
                                        <td colspan="2">
                                            <input type="text" value="{{$user_details->dob}}" id="txtdob" name="dob" readonly="readonly" class="hasDatepicker" disabled="disabled">
                                        </td>
                                    </tr>
                                    <tr>  	
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" id="txtHobbies" name="Hobbies" value="{{$user_details->hobbies}}" class="validate[required,custom[onlyLetter]] text-input">
                                        </td>

                                        <td>
                                            <label class="control-label">Blood group :  <b style="color:red;font-size:16px;">*</b></label>
                                        </td>
                                        <td>
                                            <select name="selstudbloodgrp" id="studbloodgrp">
                                    ...
                                    <tr>
                                        <td>
                                            <label class="control-label">Mobile No.: <b style="color:red;font-size:16px;">*</b></label>
                                        </td>
                                        <td>
                                            <input type="text" name="mobileNo" id="txtmobileNo" maxlength="10" value="{{$user_details->mobile_no}}">
                                        </td>
                                        <td class="body">
                                            <label class="control-label">Alternate Phone No.:</label>
                                        </td>
                                        <td align="left">
                                            <input class="form-filed" name="alternetContactNumber" type="text" id="txtAltNumber" value="{{$user_details->alternate_no}}" maxlength="10" >
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <label class="control-label">Religion : <b style="color:red;font-size:16px;">*</b></label>
                                        </td>
                                        <td>
                                            <input name="txtReligion" type="text" id="txtReligion" value="{{$user_details->religion}}" >
                                        ...
                                        <td>
                                            <label class="control-label">Category :<b style="color:red;font-size:16px;">*</b></label>
                                        </td>
                                        <td>
                                            <input name="txtCategory" type="text" id="txtCategory" value="{{$user_details->category}}" >
                                    ...
                                    <tr>
                                        <td>
                                            <label>Physically Challenged(Handicapped)<b style="color:red;font-size:16px;">*</b> </label>
                                        </td>
                                        <td colspan="4">
                                            <input type="radio" name="physicallyHandicapped" id="phYes" value="Yes" @if($user_details->is_handicaped=='Yes')checked="checked"@endif><label style="display:inline;">Yes</label>
                                            <input type="radio" name="physicallyHandicapped" value="No" id="phNo" @if($user_details->is_handicaped=='No')checked="checked"@endif><label style="display:inline;">No</label>
                                        </td>
                                    </tr>
<!--                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td id="txtAdmissionDate">
                                            {{$user_details->admission_date}}
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="4">
                                            <input type="text" value="{{$user_details->vehicle_no}}" name="vehicleNo" id="txtVehicleNo"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="4">
                                            <div align="center" style="margin-left:400px">
                                                <button type="submit" class="btn btn-inverse btn-mini">Save</button>
